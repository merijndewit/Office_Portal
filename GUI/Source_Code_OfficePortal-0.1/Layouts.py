...
Dependencies = [
        ...
        [gui.Text('Raspidmx:', background_color=textBackground), gui.Button(key=('checkRaspidmx'), button_text=('check'), mouseover_colors=Theme.mouseOver), gui.Button(visible = False ,key=('RaspidmxInstalled'),  image_filename='Pictures/Green_Check.png', border_width=0, mouseover_colors=Theme.mouseOver), gui.Button(visible = False ,key=('installRaspidmx'), image_filename='Pictures/arrow_down.png', border_width=0, mouseover_colors=Theme.mouseOver), gui.Button(visible = False ,key=('Loading4'), image_filename='Pictures/loading.png', border_width=0, mouseover_colors=Theme.mouseOver)]]
