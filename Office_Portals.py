          ...
          [gui.Text('A nerdy solution to make distant colleagues feel nearby', font=("Helcentica", 12))],
           [gui.Text('PI`s IP:'),gui.Text(getpi.getip())],
            [gui.Text('Target IP:', font = ("Helcentica", 9)),gui.Input(key='targetip', size = (20,1))],
             [gui.Text('Target pixel width:', font = ("Helcentica", 9)),gui.Input(key='targetwidth', size = (20,1))],
              [gui.Text('Target pixel height:', font = ("Helcentica", 9)),gui.Input(key='targetheight', size = (20,1))],
               [gui.Text('Target fps:', font = ("Helcentica", 9)),gui.Input(key='targetfps', size = (20,1))],
